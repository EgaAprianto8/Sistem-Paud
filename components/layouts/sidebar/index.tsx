...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-90 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                <Link href="/" className="my-auto flex-row flex gap-4">
                    ...
                    <div className="flex flex-col h-full my-auto">
                        <h1 className="font-black text-xl text-[#fff]">Media Nusa Gemilang</h1>
                    </div>
                </Link>
                <button
                    ref={trigger}
